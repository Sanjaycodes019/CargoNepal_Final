  ...
  useEffect(() => {
    if (mapRef.current && !mapInstanceRef.current) {
      ...
      const marker = L.marker([27.5119, 83.4665])
        .addTo(map)
        .bindPopup('CargoNepal Headquarters<br>Bhairahawa Siddharthanagar, Nepal')
        .openPopup();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <section className="mb-16">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8 lg:p-10">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Our Location</h2>
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
              <div className="flex-1">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">Bhairahawa Siddharthanagar</h3>
                </div>
                
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
                    Serving customers across Nepal with our headquarters based in <strong>Bhairahawa Siddharthanagar</strong>, 
                    strategically located to serve both eastern and western regions of the country.
                  </p>
                  <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
                    Located near the Indian border, providing easy access to cross-border trade and transportation routes, 
                    making it an ideal hub for logistics operations throughout Nepal.
                  </p>
                  <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                    <strong>Address:</strong> Bhairahawa Siddharthanagar, Rupandehi District, Nepal
                  </p>
                </div>
              </div>
